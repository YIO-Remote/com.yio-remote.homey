...
declare module HomeyAPI {
    ...
    class ManagerInsights {
         ...
         * @param { string } opts.uri
         * @param { string } opts.id
         * @param { string } [opts.resolution]  - The timespan to query ("lastHour" | "lastHourLowRes" | "last6Hours" | "last24Hours" | "last7Days" | "last14Days" | "last31Days" | "last3Months" | "last6Months" | "last2Years" | "today" | "thisWeek" | "thisMonth" | "thisYear" | "yesterday" | "lastWeek" | "lastMonth" | "lastYear")
         * @returns { object } Successful response
         */
        getLogEntries(opts?: {
            uri: string;
